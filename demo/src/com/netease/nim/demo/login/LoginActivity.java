    ...
    private void login() {
        ...
        loginRequest.setCallback(new RequestCallback<LoginInfo>() {
            ...
            public void onSuccess(LoginInfo param) {
                ...
                // 因为同一IP注册用户过多受了云信的限制特此下策，后续改成自己服务器
                SpUtils spUtils = new SpUtils(DemoCache.getContext());
                boolean is_havekey=  spUtils.getboolean("is_havekey");
                onLoginDone();
                DemoCache.setAccount(account);
                saveLoginInfo(account, token);


                AlexCipherClient initAlexandria= InitAlexandria.getAlexandriaInstance(account);
                ...
                if(!is_havekey) {
                    ...
                    String publickey = (String) map.get(RSACoder.PUBLIC_KEY);
